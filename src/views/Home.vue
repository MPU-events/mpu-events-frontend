<template>
  <div class="container-fluid">
    <div class="row">
      <!-- Боковая панель -->
      <div class="col-md-3 col-lg-2 sidebar" :class="{ active: isSidebarOpen }">
        <button class="menu-toggle d-md-none" id="menuToggle" @click="toggleSidebar">
        ...
        <div class="content-area">
          ...
          <div class="events-section">
            <div class="section-header">
              ...
              <a href="#" class="view-all" @click.prevent="viewAll">Смотреть все</a>
            </div>
            
            <!-- Сетка событий (превью) -->
            <div class="events-grid">
              <!-- Превью 1: Турнир по армрестлингу -->
              <div class="event-preview" @click="openEventModal(1)">
                <img 
                  src="/post_img_1.png" 
                  alt="Турнир по армрестлингу" 
                  class="event-preview__image" 
                  @error="handleImageError"
                >
                <div class="event-preview__content">
                  <h3 class="event-preview__title">Турнир по армрестлингу</h3>
              ...
              <!-- Превью 2: Выставка современного искусства -->
              <div class="event-preview" @click="openEventModal(2)">
                <div class="event-preview__image" style="background: linear-gradient(135deg, #667eea, #764ba2);"></div>
                <div class="event-preview__content">
                  <h3 class="event-preview__title">Выставка современного искусства</h3>
                  <div class="event-preview__date">
                    <i class="bi bi-calendar"></i>
                    15 ноября, 19:00
                  </div>
              ...
              <!-- Превью 3: Концерт классической музыки -->
              <div class="event-preview" @click="openEventModal(3)">
                <div class="event-preview__image" style="background: linear-gradient(135deg, #f093fb, #f5576c);"></div>
                <div class="event-preview__content">
                  <h3 class="event-preview__title">Концерт классической музыки</h3>
                  <div class="event-preview__date">
                    <i class="bi bi-calendar"></i>
                    20 ноября, 18:30
                  </div>
              ...
              <!-- Превью 4: Мастер-класс по фотографии -->
              <div class="event-preview" @click="openEventModal(4)">
                <div class="event-preview__image" style="background: linear-gradient(135deg, #4facfe, #00f2fe);"></div>
                <div class="event-preview__content">
                  <h3 class="event-preview__title">Мастер-класс по фотографии</h3>
                  <div class="event-preview__date">
                    <i class="bi bi-calendar"></i>
                    25 ноября, 16:00
                  </div>
      ...
      <div class="modal-content">
        <div v-if="selectedEvent" class="post">
          ...
          <div class="post__wrapper">
            <img 
              class="post__image" 
              :src="selectedEvent.image || 'https://via.placeholder.com/500x400/9D2ACD/ffffff?text=' + encodeURIComponent(selectedEvent.title)" 
            ...
            <div class="post__content">
              ...
              <div class="post__description">
                ...
                <button class="post__more-btn" @click="showMoreDetails">Подробнее</button>
              </div>
...
const activeFilter = ref('Все события')
const activeTab = ref('home')
const showModal = ref(false)
const isSidebarOpen = ref(false)
const selectedEvent = ref(null)

const filters = ['Все события', 'Спорт', 'Концерты', 'Театр', 'Выставки', 'Другое']

const eventsData = {
  1: {
    title: 'Турнир по армрестлингу',
    image: '/post_img_1.png',
    date: '7 ноября',
    time: '12:00-17:00',
...
const handleImageError = (e) => {
  e.target.src = 'https://via.placeholder.com/300x180/9D2ACD/ffffff?text=Турнир'
}
